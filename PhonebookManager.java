...
class PhonebookManager extends PhoneBookTest {
	...
	public static ArrayList<ListNode> firstContacts(ArrayList<ListNode> ContactList){
    	    // strings that contain the info for the default contacts in the phone book
	...
	// this method allows the user to create a contact
	...
	public static void userChoice(Scanner input){//userChoice starts
		...
		firstContacts(ContactList);// adds first contacts to phone book
		int choice = 0;
		do {//do while loop begins	
			...
			case 2: // edits a contact in the phone book
				editContact(ContactList);
				break;
			case 3:// searches for a contact in the phone book
				searchContact(ContactList);
				break;
			case 4:// print out all the contacts in the phone book
